...
3. **Bandeja de Atención del Restaurante:** El personal responderá a clientes y proveedores desde el **Panel de Administración Web del Chatbot** (`/admin`) o bandeja de atención conectada, accesible desde cualquier ordenador, tablet o navegador del restaurante.
