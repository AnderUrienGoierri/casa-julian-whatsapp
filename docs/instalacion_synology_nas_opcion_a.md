...
6. **Comprobación local**: Abre el navegador en cualquier ordenador conectado a la red local y entra a:
   ...
   *(Deberás ver el panel de Casa Julián y el Buzón de Recepción funcionando).*
...
4. Haz clic en **Aceptar**.
   *(Synology creará el dominio dinámico y generará el certificado SSL válido automáticamente).*
...
3. Rellena:
   ...
   * **Identificador de verificación (Verify Token)**:
     `casajulian123` *(el valor configurado en tu archivo `.env`)*
